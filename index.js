const FIRSTNAMES = [
	'js', 'b', 'c', 'd', 'Isaac', 'Vincent', 'Edwin',
	'Ashlyn', 'Anthony', 'Alia', 'Abby', 'Francesca'
];

const LASTNAMES = [
	'js
', 'Whitetaker', 'Glenn', 'Stephens', 'Sherman', 'Howard',
	'Kent', 'Clay', 'Beck', 'Simmons', 'Briggs', 'Lee', 'Maxwell'
];

const TITLES = [
	'js', 'President', 'Vice President', 'Director', 'Manager',
	'Developer'
];
...
function updatePaginationInfos(pagination, table, page_count, index)
{
	...
	info.innerHTML = 'visualizacion js' + from + '-' + a + ' en pagina ' + (index + 1) + '/' + page_count;
}
